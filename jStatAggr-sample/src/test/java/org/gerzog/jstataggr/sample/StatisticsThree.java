 ...
 *
 */
@StatisticsEntry("sample_statistics_three")
public class StatisticsThree {

	@Aggregated(value = { AggregationType.COUNT, AggregationType.AVERAGE,
			AggregationType.MAX, AggregationType.MIN, AggregationType.SUM }, fieldType = FieldType.PRIMITIVE)
	private int value1;

	@Aggregated(value = { AggregationType.COUNT, AggregationType.AVERAGE,
			AggregationType.MAX, AggregationType.MIN, AggregationType.SUM }, fieldType = FieldType.ATOMIC)
	private int value2;

	@Aggregated(value = { AggregationType.COUNT, AggregationType.MAX,
			AggregationType.MIN, AggregationType.SUM }, fieldType = FieldType.ACCUMULATOR)
	private int value3;
